import { parseQuery as parse, parseQueryAsync as parseAsync } from 'pg-query-native';
...
export { parse, parseAsync, deparse, walk, first, all, tables, byType, clean, verify, Deparser };
